...
class Baixing_SelectCityDialog extends StatefulWidget {
  Function(String, String) mBaixing_citySelected;

  Baixing_SelectCityDialog({Key? key, required this.mBaixing_citySelected}) : super(key: key);

  @override
  State<Baixing_SelectCityDialog> createState() =>
      _Baixing_SelectCityDialogState();
}

class _Baixing_SelectCityDialogState extends State<Baixing_SelectCityDialog> {
  // 完整省市数据
  final List<Map<String, dynamic>> provinces = [
    ...
    },
    {
      ...
      'cities': [
        ...
        {'code': '371200', 'name': '临沂市'},
        {'code': '371300', 'name': '德州市'},
        {'code': '371400', 'name': '聊城市'},
        {'code': '371500', 'name': '滨州市'},
        {'code': '371600', 'name': '菏泽市'},
      ],
    },
    {
      'code': '410000',
    ...
    },
    {
      ...
      'cities': [
        ...
        {'code': '500233', 'name': '武隆区'},
        {'code': '500240', 'name': '忠县'},
        {'code': '500241', 'name': '开州区'},
        {'code': '500242', 'name': '云阳县'},
        {'code': '500243', 'name': '奉节县'},
        {'code': '500244', 'name': '巫山县'},
        {'code': '500245', 'name': '巫溪县'},
        {'code': '500246', 'name': '石柱土家族自治县'},
        {'code': '500247', 'name': '秀山土家族苗族自治县'},
        {'code': '500248', 'name': '酉阳土家族苗族自治县'},
        {'code': '500249', 'name': '彭水苗族土家族自治县'},
      ],
    },
    {
      'code': '510000',
    ...
    },
    {
      ...
      'cities': [
        ...
        {'code': '710200', 'name': '新北市'},
        {'code': '710300', 'name': '桃园市'},
        {'code': '710400', 'name': '台中市'},
        {'code': '710500', 'name': '台南市'},
        {'code': '710600', 'name': '高雄市'},
        {'code': '710700', 'name': '基隆市'},
        {'code': '710800', 'name': '新竹市'},
        {'code': '710900', 'name': '嘉义市'},
        {'code': '711000', 'name': '新竹县'},
        {'code': '711100', 'name': '苗栗县'},
        {'code': '711200', 'name': '彰化县'},
        {'code': '711300', 'name': '南投县'},
        {'code': '711400', 'name': '云林县'},
        {'code': '711500', 'name': '嘉义县'},
        {'code': '711600', 'name': '屏东县'},
        {'code': '711700', 'name': '宜兰县'},
        {'code': '711800', 'name': '花莲县'},
        {'code': '711900', 'name': '台东县'},
        {'code': '712000', 'name': '澎湖县'},
        {'code': '712100', 'name': '金门县'},
        {'code': '712200', 'name': '连江县'},
      ],
    },
    {
      'code': '810000',
      'name': '香港特别行政区',
      'cities': [
        {'code': '810100', 'name': '中西区'},
        {'code': '810200', 'name': '东区'},
        {'code': '810300', 'name': '九龙城区'},
        {'code': '810400', 'name': '观塘区'},
        {'code': '810500', 'name': '南区'},
        {'code': '810600', 'name': '深水埗区'},
        {'code': '810700', 'name': '黄大仙区'},
        {'code': '810800', 'name': '湾仔区'},
        {'code': '810900', 'name': '油尖旺区'},
        {'code': '811000', 'name': '离岛区'},
        {'code': '811100', 'name': '葵青区'},
        {'code': '811200', 'name': '北区'},
        {'code': '811300', 'name': '西贡区'},
        {'code': '811400', 'name': '沙田区'},
        {'code': '811500', 'name': '大埔区'},
        {'code': '811600', 'name': '荃湾区'},
        {'code': '811700', 'name': '屯门区'},
        {'code': '811800', 'name': '元朗区'},
      ],
    },
    {
      'code': '820000',
      'name': '澳门特别行政区',
      'cities': [
        {'code': '820100', 'name': '花地玛堂区'},
        {'code': '820200', 'name': '圣安多尼堂区'},
        {'code': '820300', 'name': '大堂区'},
        {'code': '820400', 'name': '望德堂区'},
        {'code': '820500', 'name': '风顺堂区'},
        {'code': '820600', 'name': '嘉模堂区'},
        {'code': '820700', 'name': '圣方济各堂区'},
      ],
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          AppBar(
            title: Text("选择城市", style: Theme.of(context).textTheme.titleMedium),
            backgroundColor: Colors.white,
            centerTitle: true,
            actions: [
              TextButton(
                child: Text("完成", style: Theme.of(context).textTheme.bodyLarge,),
                onPressed: () {
                  final province = provinces[selectedProvinceIndex]["name"];
                  final city = getCities()[selectedCityIndex]["name"];
                  widget.mBaixing_citySelected(province, city);
                ...
                Expanded(
                  child: CupertinoPicker(
                    ...
                    children: provinces.map((province) {
                      return Center(child: Text(province['name']));
                    }).toList(),
                  ),
                ),
                // 城市选择器
  ...
  List<Map<String, dynamic>> getCities() {
    final province = provinces[selectedProvinceIndex];
    return province['cities'] as List<Map<String, dynamic>>;
  }
}
